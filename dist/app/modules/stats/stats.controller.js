...
const getParcelsStats = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const stats = yield stats_service_1.StatsService.getParcelsStats();
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: 200,
        success: true,
